...
ActiveRecord::Schema[7.0].define(version: 2022_09_28_012856) do
  create_table "missions", force: :cascade do |t|
    ...
    t.index ["scientist_id", "planet_id"], name: "index_missions_on_scientist_id_and_planet_id", unique: true
